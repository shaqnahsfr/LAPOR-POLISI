...
public class LaporanProses extends AppCompatActivity {
    ...
    public void getData(){
        initializeArray();
        //URL API
        AndroidNetworking.get("https://tekajeapunya.com/kelompok_9/laporpolisi/getLaporanProsesPolisi.php")
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status){
                                ...
                                Toast.makeText(LaporanProses.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
